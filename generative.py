...
def check_adjacent_for_one(flat_image: list[int], flat_pixel: int) -> bool:
    ...
    if unflatten_row_index < DIMENSIONS and unflatten_col_index < DIMENSIONS:
        ...
        if check_adjacent_left(image, unflatten_row_index, unflatten_col_index) or check_adjacent_right(image, unflatten_row_index, unflatten_col_index) or check_adjacent_vertical(image, unflatten_row_index, unflatten_col_index):
            is_adjacent = True
